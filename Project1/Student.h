...
public:
	...
	//setStudentInfo
	void setStudentInfo(const string &fName, const string &lName, int newID, bool tuitionPaid, const vector<Course> &courseVector);
	...
	//billingAmount
	double billingAmount(double tuition) const;
